# SpineCodex 0.4.0 candidate

Development candidate; not published. Regression validation is still in progress.
...
See [migration validation](migration/VALIDATION.md) for completed checks and
