...
Expects the binary containing `codex-core` to run the equivalent of `spine-codex sandbox` when `arg0` is `codex-linux-sandbox`. See the `codex-arg0` crate for details.
